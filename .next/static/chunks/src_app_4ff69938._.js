...
if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STEAM_KEY) {
    throw new Error('Missing required environment variable: STEAM_KEY');
}
const STEAM_KEY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STEAM_KEY; // Puedes añadir más variables aquí según tus necesidades:
 // export const ANOTHER_KEY = process.env.ANOTHER_KEY ?? '';
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/services/steamService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "RelsolveVanityURL": (()=>RelsolveVanityURL),
    "getPlayerSummaries": (()=>getPlayerSummaries)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/config.ts [app-client] (ecmascript)"); // cargado desde process.env en build
;
const BASE = 'https://api.steampowered.com';
async function getPlayerSummaries(steamIds) {
    const url = `${BASE}/ISteamUser/GetPlayerSummaries/v2/?key=${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STEAM_KEY"]}&steamids=${steamIds.join(',')}`;
    const res = await fetch(url);
    if (!res.ok) throw new Error(`Steam API error: ${res.status}`);
    const json = await res.json();
    return json.response.players;
}
async function RelsolveVanityURL(vanityUrl) {
    const url = `${BASE}/ISteamUser/ResolveVanityURL/v1/?key=${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STEAM_KEY"]}&vanityurl=${vanityUrl}`;
    const res = await fetch(url);
    if (!res.ok) throw new Error(`Steam API error: ${res.status}`);
    const json = await res.json();
    return json.response.steamid;
}
_c = RelsolveVanityURL;
var _c;
__turbopack_context__.k.register(_c, "RelsolveVanityURL");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function SteamProfileSearch({ onProfileFound, className = '' }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const extractedId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$steamUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractSteamID"])(input);
            if (extractedId) {
                steamId = extractedId;
            } else {
...
//# sourceMappingURL=src_app_4ff69938._.js.map