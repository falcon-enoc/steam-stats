...
function useSteamSearch() {
    ...
    const searchProfile = async (input)=>{
        ...
        try {
            ...
            // ID puro
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$steamUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSteamID64"])(raw)) return raw;
            // Extraído de URL o texto
            const extracted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$steamUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extractSteamID"])(raw);
...
function useSteamPlayer(steamId) {
    const { data, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(()=>steamId && `/api/getPlayerSummaries?steamids=${steamId}`, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$fetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]);
    return {
...
function useReolveVanityURL(vanityUrl) {
    const { data, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(()=>vanityUrl && `/api/resolveVanityURL?vanityurl=${vanityUrl}`, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$fetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]);
    return {
        steamId: data,
        isError: error
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e887f58._.js.map